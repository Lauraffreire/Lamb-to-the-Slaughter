...
function mostrarResultado() {
    ...
    if (percentage <= 15) {
        ...
        tisposptle = "Cidadão Funcional (16–35%)";
        videoSrc = "img/35.mp4";
        audioSrc = "som/35.mp3";
        ...
        title = "Serenidade Sombria (36–55%)";
        videoSrc = "img/55.mp4";
        audioSrc = "som/55.mp3";
